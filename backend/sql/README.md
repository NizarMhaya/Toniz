...
Description de notre frontend. Différents login/pass pour tester.
...
nutriment_type (chaîne, optionnel) - Type de nutriment à récupérer (par exemple, "ENERGIE_100G", "MATIERES_GRASSES", etc.). Par défaut, "ENERGIE_100G".
Exemple de requête :
