...
<form id="connexion-form">
    ...
    <script>
        let apiUrlProfil = "<?php require_once 'config.php'; // j'utilise en chemin relatif vers config dont le but est de ne plus utiliser de lien en dur pour l'API...
                        echo _API_URL_PROFIL; ?> "; // utilisation de la variable définie dans config
    </script>
